...
float eps = 2;
int minPts = 10;
int clusters[30][NUM_POINTS][2] = {0};
...
float eps_2 = 8;
int minPts_2 = 5;
int clusters_2[30][NUM_POINTS][2] = {0};
...
void dbscan(int data[NUM_POINTS][2], float eps, int minPts, int clusters[30][NUM_POINTS][2], int len_clusters[30], int no_clusters[NUM_POINTS][2], int *len_no_clusters);
int find_cluster(int point[2], int clusters[30][NUM_POINTS][2], int len_clusters[30]);
...
int expand_cluster(int data[NUM_POINTS][2],int neighbors[NUM_POINTS][2],float eps,bool visited[NUM_POINTS],int cluster[NUM_POINTS][2],int len_neighbors)//,int point[2],,   int minPts,  )
{
    ...
    int new_neighbors[NUM_POINTS][2];
    int point_aux[2];
