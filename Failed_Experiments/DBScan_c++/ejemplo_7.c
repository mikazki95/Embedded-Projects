...
int get_neighbors(float data[NUM_POINTS_2][2], float point[2], float eps, float neighbors[NUM_POINTS_2][2]);// cambiar neighbors[NUM_POINTS_2][2])
...
int get_neighbors(float data[NUM_POINTS_2][2], float point[2], float eps, float neighbors[NUM_POINTS_2][2])
{
...
int main()
{
    float data[NUM_POINTS_2][2] = {0}; // Aquí debes inicializar los datos de entrenamiento
    float eps = 2;
    int minPts = 10;
    float clusters[NUM_POINTS][NUM_POINTS][2] = {0};
    int len_clusters[NUM_POINTS] = {0};
    float no_clusters[NUM_POINTS][2] = {0};
    int len_no_clusters = 0;

    float eps_2 = 8;
    int minPts_2 = 5;
    float clusters_2[NUM_POINTS_2][NUM_POINTS_2][2] = {0};
    int len_clusters_2[NUM_POINTS] = {0};
    float no_clusters_2[NUM_POINTS][2] = {0};
