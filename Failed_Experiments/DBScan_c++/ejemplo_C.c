...
///////////////////////////////////////////////////////////////////////////////////
   ...
   /*
    ...
    for (int i = 0; i < NUM_POINTS; i++)
    {
        if (len_clusters_2[i] > 0)// se debe ver  19 y varios datos de cluster, el cluster en 0 es medio secuencial i es estable e cluster en 1 es variable 
        {
            printf("Cluster %d:\n", i + 1);
  ...
  */
    ...
    {
        printf("dato %i: (%i, %i)\n", i, no_clusters_2[i][0], no_clusters_2[i][1]);
    }
