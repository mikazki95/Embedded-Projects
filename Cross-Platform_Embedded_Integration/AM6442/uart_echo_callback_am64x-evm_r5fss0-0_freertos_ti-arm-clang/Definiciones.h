...
#define NUM_POINTS                  (1000U)    // tamaño de array 1000
#define NUM_POINTS_2                (210U)     // tamaño de cluster = NUM_POINTS_2 / Minimo de puntos mínimo  210
...
int   pulso[750][2]={0};//se cambio a 2k porque generaba un bug con la asistole
