...
int main() {
    ...
    for (int t = 0; t < 2; t++) {
        ...
        for (int i = 0; i < SIZE / STEP; i++) {
            ...
            if (errors >= 50 ){
                printf("  ❌ Se llego al limite de errores %02d", errors);
                break;
            }
        }
        if (errors == 0) {
...
/*tarjeta 1 al encender... 
  ❌ Error en offset 0x3F80: esperado 0xAAAA, leído 0x72F3
  ❌ Error en offset 0x3F82: esperado 0xAAAA, leído 0x3158
  ❌ Error en offset 0x3F84: esperado 0xAAAA, leído 0x3DFD

  tarjeta 2 al encender...
  ❌ Error en offset 0x3F80: esperado 0xAAAA, leído 0x4577
  ❌ Error en offset 0x3F82: esperado 0xAAAA, leído 0xAFB6
  ❌ Error en offset 0x3F84: esperado 0xAAAA, leído 0x5A8D
  */